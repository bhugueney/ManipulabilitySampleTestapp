...
/*bezier_curve Function tests*/
void ExactBezierCurveTest(bool& error)
{
	std::string errMsg("In test ExactBezierCurveTest ; unexpected result for x ");
	point_t a(1,2,3);
	point_t b(2,3,4);
	point_t c(3,4,5);
	point_t d(3,6,7);
	...
	// 2d curve
	bezier_curve_t* cf(spline::exact_bezier<double, double, 3, true, point_t>(params.begin(), params.end()));
	point_t res1;
	res1 = (*cf)(0); 
	point_t x20 = a ;
	ComparePoints(x20, res1, errMsg + "2(0) ", error);
	...
	//3d curve
	params.push_back(c);
	bezier_curve_t* cf3(spline::exact_bezier<double, double, 3, true, point_t>(params.begin(), params.end()));
	res1 = (*cf3)(0); 
	ComparePoints(a, res1, errMsg + "3(0) ", error);

	res1 = (*cf3)(0.5); 
	ComparePoints(b, res1, errMsg + "3(0.5) ", error);
	...
	//4d curve
	params.push_back(d);
	bezier_curve_t* cf4(spline::exact_bezier<double, double, 3, true, point_t>(params.begin(), params.end(), 0.4, 2));
	res1 =(*cf4)(0); 
	ComparePoints(a, res1, errMsg + "3(0) ", error);
	
	res1 = (*cf4)(0.33 * 2); 
	ComparePoints(b, res1, errMsg + "3(0.33) ", error);

	
	res1 = (*cf4)(0.67 * 2); 
	ComparePoints(c, res1, errMsg + "3(0.67) ", error);

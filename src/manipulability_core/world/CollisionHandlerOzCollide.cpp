...
#include "CollisionHandlerOzCollide.h"
...
CollisionHandlerOzCollide::CollisionHandlerOzCollide()
...
void CollisionHandlerOzCollide::AddObstacle(const Obstacle* obstacle)
{
...
void CollisionHandlerOzCollide::Instantiate()
{
	// TODO
	pImpl_->BuildCollisionTree();
}

bool CollisionHandlerOzCollide::IsColliding(const Robot& robot, const Tree& tree)
{
	// TODO
